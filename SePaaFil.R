# Oppdatering 7.oktober: Siden linjene under n� skal kj�res automatisk ved oppstart av prosjektet, 
# skal det ikke lenger v�re n�dvendig � gj�re dette manuelt. De er derfor kommentert bort, men kan 
# gjenopprettes for � kj�res ved behov (dersom alle funksjonene ikke ligger i Environment)
#---------------------------------------------------------------------------------------------
