...
Hoved hjernen til data prosessering for helseprofilene ie. FHP og OVP. Flere Stata do filer er også nødvending for at alle funksjonene skal funke, men de er ikke inkludert her.
...
Nye idé eller løsninger i Access kan testes ved bruk av filen [[https://github.com/helseprofil/khfunctions/blob/master/run-test.R][run-test.R]]. Der
