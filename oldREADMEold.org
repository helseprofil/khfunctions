...
=KHfunctions= er hovedsakelig utviklet og skrevet av [[https://www.fhi.no/om/organisasjon/helse-og-ulikhet/kare-bavre/][Kåre Bævre]]. Videre
utvikling som er gjort deretter er bare minimal. I tillegg til Access database,
flere Stata do filer er også nødvending for at alle funksjonene skal funke, men
...
For å bruke gammel versjon før oppdatering til allviskube, kjør kodene nedenfor:
